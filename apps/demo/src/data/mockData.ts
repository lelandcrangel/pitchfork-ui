...
export const recentSignups: Signup[] = [
  { id: '1', name: 'Sofia Reyes', email: 'sofia@acme.co', plan: 'Pro', status: 'Active', date: 'Jun 2, 2026', country: 'Mexico' },
  { id: '2', name: 'Marcus Webb', email: 'mwebb@startup.io', plan: 'Enterprise', status: 'Active', date: 'Jun 2, 2026', country: 'United States' },
  { id: '3', name: 'Yuki Tanaka', email: 'yuki.t@gmail.com', plan: 'Free', status: 'Pending', date: 'Jun 1, 2026', country: 'Japan' },
  { id: '4', name: 'Priya Sharma', email: 'priya@design.co', plan: 'Pro', status: 'Active', date: 'Jun 1, 2026', country: 'India' },
  { id: '5', name: 'Carlos Mendes', email: 'carlos@ventura.br', plan: 'Pro', status: 'Active', date: 'May 31, 2026', country: 'Brazil' },
  { id: '6', name: 'Anya Müller', email: 'anya.m@tech.de', plan: 'Free', status: 'Churned', date: 'May 30, 2026', country: 'Germany' },
  { id: '7', name: 'James Okafor', email: 'james@fintech.ng', plan: 'Enterprise', status: 'Active', date: 'May 29, 2026', country: 'Nigeria' },
  { id: '8', name: 'Lea Fontaine', email: 'lea.f@studio.fr', plan: 'Pro', status: 'Pending', date: 'May 28, 2026', country: 'France' },
];
