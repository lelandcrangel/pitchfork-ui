...
const CSS_VARIABLE_CONTROLS: CssVariableControl[] = [
  ...
  {
    name: '--pf-button-destructive-bg',
    label: 'Button destructive bg',
  ...
  {
    name: '--pf-button-destructive-bg-hover',
    label: 'Button destructive hover bg',
    defaultValue: 'var(--color-danger-700)',
    type: 'color',
    scopes: ['button'],
    variants: ['destructive'],
  },
  {
    name: '--pf-button-destructive-text',
    label: 'Button destructive text',
    defaultValue: 'var(--color-base-white)',
    type: 'color',
    scopes: ['button'],
    variants: ['destructive'],
  ...
  {
    name: '--pf-contextmenu-bg',
    label: 'Context menu bg',
    defaultValue: 'var(--pf-surface-bg)',
    type: 'color',
    scopes: ['contextmenu'],
  },
  {
    name: '--pf-contextmenu-item-active-bg',
    label: 'Context menu active item bg',
    defaultValue: 'var(--color-semantic-action-primary)',
    type: 'color',
    scopes: ['contextmenu'],
  },
  {
    name: '--pf-contextmenu-text-danger',
    label: 'Context menu destructive text',
    defaultValue: 'var(--color-semantic-status-danger-foreground)',
    type: 'color',
    scopes: ['contextmenu'],
  },
  ...
  {
    name: '--pf-resizable-handle-bg',
    label: 'Resizable handle bg',
    defaultValue: 'var(--color-semantic-border-default)',
    type: 'color',
    scopes: ['resizable'],
  },
  {
    name: '--pf-resizable-handle-active-bg',
    label: 'Resizable handle active bg',
    defaultValue: 'var(--color-semantic-action-primary)',
    type: 'color',
    scopes: ['resizable'],
  },
  {
    name: '--pf-resizable-grip',
