  ...
  return (
    ...
    >
      <div className="pf-section-header__content">
        {eyebrow ? <p className="pf-section-header__eyebrow">{eyebrow}</p> : null}
        <h2 className="pf-section-header__heading">{heading}</h2>
        {description ? <p className="pf-section-header__description">{description}</p> : null}
        {metadata ? <div className="pf-section-header__metadata">{metadata}</div> : null}
        {children}
      </div>

      {actions ? <div className="pf-section-header__actions">{actions}</div> : null}
    </header>
  );
});
