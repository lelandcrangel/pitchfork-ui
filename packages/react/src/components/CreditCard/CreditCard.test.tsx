...
describe('CreditCard', () => {
  it('renders the cardholder name', () => {
    render(
      <CreditCard cardNumber="4111111111111111" cardholderName="Jane Doe" expiry="12/26" />,
    );
  ...
  it('does not render the CVC row when cvc is omitted', () => {
    render(
      <CreditCard cardNumber="4111111111111111" cardholderName="Jane" expiry="01/27" />,
    );
  ...
  it('applies the brand CSS class', () => {
    const { container } = render(
      <CreditCard cardNumber="4111111111111111" cardholderName="Jane" expiry="01/27" brand="visa" />,
    );
